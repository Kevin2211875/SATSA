...
import UIS.SATSA.Response.UpdateUserRequest;
...
public class AuthService {
    ...
    public AuthService(UsuarioRepository repository, TokenRepository tokenRepository, PasswordEncoder passwordEncoder, UsuarioRolRepository usuarioRolRepository, JwtService jwtService, AuthenticationManager authenticationManager) {
    ...
    public TokenResponse register(final RegisterRequest request) {
        ...
        final UsuarioRol usuarioRol = new UsuarioRol();
