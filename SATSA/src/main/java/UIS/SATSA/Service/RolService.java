...
import UIS.SATSA.Repository.RolRepository;
...
public class RolService implements RolRepository {
    ...
    @Override
    public Rol getOne(Integer integer) {
        return null;
    }

    @Override
    public Rol getById(Integer integer) {
        return null;
    }

    @Override
    public Rol getReferenceById(Integer integer) {
        return null;
    }
    ...
    @Override
    public List<Rol> findAllById(Iterable<Integer> integers) {
        return List.of();
    }
