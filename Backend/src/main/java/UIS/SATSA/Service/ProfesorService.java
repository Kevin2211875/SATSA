...
import UIS.SATSA.Model.Profesor;
import UIS.SATSA.Repository.ProfesorRepository;
...
public class ProfesorService implements ProfesorRepository {
    @Override
    public void flush() {
    ...
    @Override
    public Profesor getOne(Integer integer) {
        return null;
    }

    @Override
    public Profesor getById(Integer integer) {
        return null;
    }

    @Override
    public Profesor getReferenceById(Integer integer) {
        return null;
    }
    ...
    @Override
    public List<Profesor> findAllById(Iterable<Integer> integers) {
        return List.of();
    }
